package com.wallet0x.binancechainkit

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import com.wallet0x.binancechainkit.core.Asset
...
import com.wallet0x.binancechainkit.managers.BalanceManager
import com.wallet0x.binancechainkit.managers.TransactionManager
...
import com.wallet0x.binancechainkit.storage.KitDatabase
import com.wallet0x.binancechainkit.storage.Storage
...
class BinanceChainKit(
    ...
    fun validateAddress(address: String) {
        com.wallet0x.binancechainkit.helpers.Crypto.decodeAddress(address)
    }
