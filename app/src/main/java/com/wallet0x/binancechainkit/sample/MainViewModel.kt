package com.wallet0x.binancechainkit.sample
...
class MainViewModel : ViewModel() {
    ...
    private fun init() {
        ...
        binanceChainKit = BinanceChainKit.instance(com.wallet0x.binancechainkit.sample.App.instance, words, passphrase, "MyBinanceWallet", BinanceChainKit.NetworkType.TestNet)
